/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 3f265292ca068e8d9481f395f02e85a7)
...
interface __BaseEnv_Env {
	...
	SOLANA_V2_PROGRAM_ID: string;
	SOLANA_PRIVATE_RPC_URL: string;
	TRIPS: DurableObjectNamespace<import("./src/index").TripRoom>;
	USERS: DurableObjectNamespace<import("./src/index").UserAccount>;
	LOBBY: DurableObjectNamespace<import("./src/index").TripDirectory>;
	AUTH: DurableObjectNamespace<import("./src/index").IdentityRegistry>;
	GOVERNANCE: DurableObjectNamespace<import("./src/index").GovernanceStore>;
	CHAIN: DurableObjectNamespace<import("./src/index").ChainJourney>;
	COMMUNITY: DurableObjectNamespace<import("./src/index").CommunityLedger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TripRoom" | "UserAccount" | "TripDirectory" | "IdentityRegistry" | "GovernanceStore" | "ChainJourney" | "CommunityLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "AUTH_DOMAIN" | "SITE_ORIGIN" | "ALLOWED_ORIGINS" | "SOLANA_NETWORK" | "COMMUNITY_ENABLED" | "COMMUNITY_PROGRAM_ID" | "RESTORE_ALLOWED" | "OPENAI_ENABLED" | "OPENAI_MODEL" | "NOTIFICATIONS_ENABLED" | "ELEVENLABS_VOICE_ID" | "SOLANA_PROGRAM_ID" | "SOLANA_RPC_URL" | "SOLANA_V2_PROGRAM_ID" | "SOLANA_PRIVATE_RPC_URL">> {}
}
